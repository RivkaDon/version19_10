...
//small test
int main(){
    STDtest std("/home/rivka/CLionProjects/version18.10/input.txt","/home/rivka/CLionProjects/version18.10/output.txt");
    CLI cli(&std);
    cli.start();
    std.close();
    check("/home/rivka/CLionProjects/version18.10/output.txt","/home/rivka/CLionProjects/version18.10/expectedOutput.txt");
    cout<<"done"<<endl;
    return 0;
}
