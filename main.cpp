...
void clientSide2(int port,string outputFile)throw (const char*){
    ...
    ofstream out(outputFile);
    ifstream in("/home/rivka/CLionProjects/version18.10/input.txt");
    string input="";
    while(input!="6"){
        readMenue(out,serverFD);
        getline(in,input);
...
int main(){
    ...
    string outputFile1="/home/rivka/CLionProjects/version18.10/output_menu";
    string outputFile2="/home/rivka/CLionProjects/version18.10/output";
    int x=rand() % 1000;
    ...
    size_t mistakes = check(outputFile1,"/home/rivka/CLionProjects/version18.10/expected_output_menu.txt");
    mistakes += check(outputFile2,"/home/rivka/CLionProjects/version18.10/expected_output.txt");
